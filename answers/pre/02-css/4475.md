...
![](https://s3.cn-north-1.amazonaws.com.cn/tws-upload/images/1550996268230-5d9e12f7-60a7-4ef5-96b2-cdac2c3bbe09.jpg)
...
<body>
    ...
    <form>
        ...
        <table>
        	            <tr>
                <td>班级(必填):<input type="text" name="class" required></td>
                <td>学号(必填)：<input type="text" name="idcard" required></td>
                <td>姓名(必填)：<input type="text" name="name" required></td>
            </tr>
        </table>
         </div>
        ...
        <div id="foot" style="text-align: center">
        	<button type="button" style="background-color: #6666e0;border-radius: 6px 6px 6px 6px;width: 99px;height: 35px;">
        		计算分数
        	</button>
        </div>
    </form>
